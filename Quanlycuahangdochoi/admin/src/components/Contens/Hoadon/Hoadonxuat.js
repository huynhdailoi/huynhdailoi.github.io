    ...
    <div>
      <>
        <div className="row p-2 g-0">
          <div className="col">
            <span className="h4 text-warning">Hóa đơn xuất</span>
          </div>
        </div>
        ...
        <div className="row p-2 g-0">
            ...
            <table className="table table-white table-striped">
              ...
              <tbody>
                ...
                <tr className="row">
                  ...
                  <td className="col">Máy bay điều khiển</td>
                  <td className="col">
                    <input
                      aria-label="quantity"
                      className="input-qty form-control"
          ...
          <div className="col-4 ps-3">
            <div className="card p-3">
              ...
              <div className="row mb-3">
                <div className="col">Tiền khách trả</div>
                <div className="col-6">
                  <input
              ...
              <div className="row mb-3">
                <div className="col">Tiền thừa trả khách</div>
                <div className="col">__________________</div>
              </div>
              <div className="row mb-3">
                <div className="col">Tổng tiền</div>
                <div className="col">
                  <span className="text-danger h3">360.000</span>
                </div>
              </div>
